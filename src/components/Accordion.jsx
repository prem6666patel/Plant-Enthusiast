...
const data = [
  {
    icon: <FaSeedling />,
    heading: "Expert Plant Care",
    detail:
      "Our plant care services include regular watering, trimming, and ensuring optimal growth conditions for your indoor and outdoor plants. We help them thrive in any environment.",
  },
  {
    icon: <HiOutlineHeart />,
